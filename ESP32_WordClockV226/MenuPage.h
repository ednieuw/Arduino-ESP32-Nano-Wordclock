...
.tbtn                { border-color: var(--border); color: var(--muted); }
...
.bright-row { display: flex; gap: 12px; align-items: flex-start; }
...
<div class="card">
  ...
  <!-- Q Display colour -->
  <div class="card-title">Display Colour &mdash; Q0&ndash;Q8</div>
  <div class="q-ticks">
    <span>0</span><span>1</span><span>2</span><span>3</span><span>4</span>
    <span>5</span><span>6</span><span>7</span><span>8</span>
  </div>
  <input type="range" id="qslider" min="0" max="8" step="1" value="0"
...
var qnames = ['Default colour','Hourly colour','White','Own colour',
              'Own + HetIsWas','Wheel colour','Digital','Hourly + HetIsWas','Rainbow'];
