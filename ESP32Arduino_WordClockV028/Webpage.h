...
.style7 {
  ...
  <body>
   ...
   <span class="auto-style3"><a href="https://github.com/ednieuw/Arduino-ESP32-Nano-Wordclock">ESP32-Nano Word Clock</a></td>
     ...
     <tr>
       <td colspan="3" class="auto-style16"><div align="center" class="style3 style9">Language</div></td>
     </tr>
     <tr>
     ...
     <tr>
	  ...
	  <tr>
	    <td colspan="3"><span class="auto-style16"><strong>F</strong> Own colour (<span class="style1">Hex code</span> <span class="style1">F<span class="style4">WW</span></span><span class="style5">RR</span><span class="style7">GG</span><span class="style8">BB)</span></span></td>
     </tr>
	  <tr>
