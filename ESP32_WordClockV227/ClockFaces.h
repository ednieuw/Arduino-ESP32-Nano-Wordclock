...
const uint32_t LEDNEARLDR = 9999;                                                              // Pos of LDR near a LED then. Turn ot one second ofd to read LDR
const byte MATRIX_WIDTH   =  17;                                                              // NA Not used in this clock. 16 is fine 
const byte MATRIX_HEIGHT  =  17;                                                              // NA Not used in this clock. 16 is fine 
                 
#define HET     ColorLeds("Het",       0,   9, MINColor);                                     // Special adapted clock face
#define IS      ColorLeds("is",       10,  15, SECColor);     Is = true;    //ColorLeds("", 8,10, 0); 
#define WAS     ColorLeds("was",      10,  15, SECColor);     Is = false;  // ColorLeds("", 4, 5, 0); 
#define MVIJF   ColorLeds("vijf",     16,  28, LetterColor); 
#define MVOOR   ColorLeds("voor",     29,  41, LetterColor);
#define MTIEN   ColorLeds("tien",     42,  54, LetterColor); 
#define OVER    ColorLeds("over",     55,  67, LetterColor);
#define KWART   ColorLeds("kwart",    68,  83, LetterColor);
#define OVER2   ColorLeds("over",     84,  96, LetterColor);
#define HALF    ColorLeds("half",     97, 109, LetterColor);
#define VOOR    ColorLeds("voor",    110, 122, LetterColor);
#define EEN     ColorLeds("een",     123, 131, LetterColor);
#define DRIE    ColorLeds("drie",    132, 144, LetterColor);
#define TWEE    ColorLeds("twee",    145, 157, LetterColor);
#define VIER    ColorLeds("vier",    158, 170, LetterColor);
#define VIJF    ColorLeds("vijf",    171, 183, LetterColor);
#define ZES     ColorLeds("zes",     184, 192, LetterColor);
#define NEGEN   ColorLeds("negen",   193, 208, LetterColor);
#define ZEVEN   ColorLeds("zeven",   209, 224, LetterColor);
#define ACHT    ColorLeds("acht",    225, 237, LetterColor);
#define TIEN    ColorLeds("tien",    238, 250, LetterColor);
#define ELF     ColorLeds("elf",     251, 259, LetterColor);
#define TWAALF  ColorLeds("twaalf",  269, 288, LetterColor);
#define UUR     ColorLeds("uur",     260, 268, LetterColor);
#define MIN1    ColorLeds("M1",      289, 289, LetterColor); 
#define MIN2    ColorLeds("M2",      290, 290, LetterColor);       //MINColor); 
#define MIN3    ColorLeds("M3",      291, 291, LetterColor);
#define MIN4    ColorLeds("M4",      292, 292, LetterColor); 
#define EDSOFT  ColorLeds("EdSoft",  293, 293, LetterColor);
                     #endif //NLM1M2M3M4L294