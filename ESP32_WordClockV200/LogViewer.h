...
//            statusEl.className = 'status';
        ...
        function displayLog(data) {
            ...
            // Build HTML for all lines   //print line number  after line html +=`<div class="log-line">       <span class="line-number">${lineNum}</span>                 
            let html = '';
        ...
        function toggleAutoRefresh() {
            ...
            if (checkbox.checked) {
                ...
                autoRefreshInterval = setInterval(fetchLog, 500); // Then every 1 seconds
            } else {
