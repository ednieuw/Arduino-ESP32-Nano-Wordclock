...
const byte MATRIX_HEIGHT =  29;                                                               // Grid size For digital display mode.
                     ...
                     #ifdef NL4
#define HET     ColorLeds("Het",      0,   2, LetterColor);           // Special adapted clock face
#define IS      ColorLeds("is",       4,   5, LetterColor);     Is = true;    //ColorLeds("", 4, 5, 0); IS and WAS are equal. There is no WAS
#define WAS     ColorLeds("was",      4,   5, LetterColor);     Is = false;  // ColorLeds("", 4, 5, 0); 
...
#define EDSOFT { ColorLeds("EdSoft",   6,   7, LetterColor);  ColorLeds("", 46,  49, LetterColor); ColorLeds("",  56, 61, LetterColor); ColorLeds("", 101, 106, LetterColor);}
                     #endif //NL4
                     #ifdef UK4
#define IT      ColorLeds("| It",   337, 338, UKLetterColor);   
#define ISUK    ColorLeds("is",     340, 341, UKLetterColor); 
#define WASUK   ColorLeds("was",    340, 341, UKLetterColor);
...
#define OCLOCK  ColorLeds("O'clock",661, 666, UKLetterColor);
                      #endif //UK
                      #ifdef DE4
#define ES      ColorLeds("\nEs",   353, 354, DELetterColor);   
#define IST     ColorLeds("ist",    356, 358, DELetterColor); 
#define WAR     ColorLeds("war",    356, 358, DELetterColor); 
...
#define UHR     ColorLeds("uhr",    645, 647, DELetterColor);
                      #endif //DE4
                      #ifdef FR4
#define IL      ColorLeds("| Il",    16,  17, FRLetterColor);   
#define EST     ColorLeds("est",     19,  21, FRLetterColor); 
#define ETAIT   ColorLeds("etait",   19,  21, FRLetterColor);
